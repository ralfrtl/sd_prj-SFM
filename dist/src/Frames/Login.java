...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label_icon.setBackground(new java.awt.Color(0, 153, 51));
        label_icon.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        label_icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sys Img/Logo/COLM x200.png"))); // NOI18N
        BG.add(label_icon);
        label_icon.setBounds(73, 20, 200, 200);
...
//                            pc_user = account.next();
//                            pc_pass = account.next();
//                        }
//                        if ((pc_user.equals(input_user.getText())) && (pc_pass.equals(pass))){
//                            Home home = new Home();
//                            home.label_user.setText(input_user.getText());
//                            home.label_user.setToolTipText(input_user.getText());
//                            home.label_user.setName(""+rs.getInt("User_ID"));
//                            home.MyFiles(new File("src\\root"));
...
//                        }
//                        else {
//                            JOptionPane.showMessageDialog(this, "This account can't be used to this pc.","Err",JOptionPane.ERROR_MESSAGE);
//                        }
                        Home home = new Home();
                        home.label_user.setText(input_user.getText());
                        home.label_user.setToolTipText(input_user.getText());
                    ...
                    JOptionPane.showMessageDialog(this, "Username or Password is invalid.","Err",JOptionPane.ERROR_MESSAGE);
                }
            } catch (Exception e) {
...
//                    if ((ip.contains(":")==false)&&(!ip.equals("127.0.0.1"))){
        ...
        try {
            ps = con.prepareStatement("UPDATE tbl_user SET User_IP = ?, User_Port = ? WHERE User_ID = ?");
            ps.setString(1, my_ip);
            ps.setInt(2, SS.port);
            ps.setInt(3, id);
            ps.execute();
        } catch (Exception e) {
